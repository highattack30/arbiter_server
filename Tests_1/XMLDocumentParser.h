...
public:
	...
	public:
		...
		XMLNodeArgument * GetArgument(STRING argumentName);
		void reset_args();
...
public:
	static const bool ParseZoneXMLDocument(const char* fileName, std::vector<zone_template>& out_zones);
...
private:
	...
	static void BuildZone(XMLNode* mainNode, std::vector<zone_template>& out_zones);
